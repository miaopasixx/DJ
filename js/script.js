                        ...
                        ${imageFiles.map(file => {
                            ...
                            return `
                                <div style="position: relative; margin-bottom: 30px; width: calc(16.66% - 10px);">
                                    ...
                                    <h4 style="position: absolute; bottom: -35px; left: 0px; color: white; background: rgba(0, 0, 0, 0.5); padding: 2px 5px; border-radius: 3px; transform: translateY(30px);">${fileObj.name}</h4>
                                </div>
                            `;
                        }).join('')}
                    </div>
